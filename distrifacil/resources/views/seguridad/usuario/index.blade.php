...
<div class="row">
   ...
   <a href="usuario/create"><button class="btn btn-success">Agregar Nuevo Administrador</button></a>
</div>
          ...
          <th>Eliminar</th>
               ...
               @foreach ($usuarios as $usu)
				<tr>
					...
					<td>{{ $usu->email}}</td>
					<td>
						<a href="{{URL::action('UsuarioController@edit',$usu->id)}}"><button class="btn btn-info">Editar</button></a></td>  <td>
